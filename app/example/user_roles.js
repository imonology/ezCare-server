...
l_handlers.TEST_ROLE = function (event) {
	...
	//IC.User.addRolePermission('TEST_ROLE', ['admin']);
	//IC.User.removeRolePermission('TEST_ROLE', ['admin']);
	//IC.User.queryRolePermission('TEST_ROLE');
...
l_handlers.SET_ROLE = function (event) {
	...
	var result = IC.Handler.setPermission(event_name, role, type);
